function Footer() {
  return (
    <div className="h-screen w-full p-20 flex gap-10">
      <div className="w-1/2 flex flex-col justify-between ">
        <div className="headings uppercase">
          <h1 className="text-8xl leading-none font-semibold ">Eye-</h1>
          <h1 className="text-8xl leading-none font-semibold ">Opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2">
        <div>
          <h1 className="text-8xl leading-none font-semibold">Presentations</h1>
        </div>
        <div className="flex justify-between">
          <div className="pt-14">
            <h1 className="font-semibold pb-5 ">S:</h1>
            ...
            <div className="pt-10">
              <h1 className="font-semibold pb-5 ">L:</h1>
              {[
                "202-1965 W 4th Ave",
                "Vancouver, Canada",
                "30 Chukarina St",
                ...
                return (
                  <div>
                    <a key={index} href="google.com" className="underline">
                      {" "}
                      {item}
                    </a>
                  </div>
            ...
            <div className="pt-5">
              <h1 className="font-semibold pb-5 ">E:</h1>
              {["hello@ochi.design", "heymoiz@gmail.com"].map((item, index) => {
                return (
                  <div>
                    <a key={index} href="google.com" className="underline">
                      {" "}
          ...
          <div className="pt-64">
            <h1 className="font-semibold pb-5">M:</h1>
            {[
              "Home",
              "Services",
              "Our work",
